...
pub fn build(b: *std.Build) void {
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "tree-sitter-d/queries/highlights.scm");
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "tree-sitter-d/queries/injections.scm");
