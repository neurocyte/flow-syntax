...
pub fn build(b: *std.Build) void {
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "tree-sitter-ink/queries/highlights.scm");
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "tree-sitter-wat/queries/highlights.scm");
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "tree-sitter-wat/queries/tags.scm");
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "nvim-treesitter/runtime/queries/yaml/highlights.scm");
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "nvim-treesitter/runtime/queries/gdscript/highlights.scm");
    ...
    ts_queryfile(b, tree_sitter_dep, ts_bin_query_gen, "nvim-treesitter/runtime/queries/gdscript/injections.scm");
